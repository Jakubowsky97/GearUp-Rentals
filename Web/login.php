...
<html>
    <head>
        ...
        <title>GearUp Rentals - Zaloguj się</title>
                ...
                <div class="content">
                    <div class="login-page">
                        <div class="login-text">
                            <h2>Zaloguj się</h2>
                            <p>Nie masz konta? <a class="register-text" href="../Web/register.php">Zarejestruj się</a></p>
                        </div>
                        ...
                        <div class="login-box">
                            <form action="logininc.php" method="post">
                                <label for="login">E-mail lub nazwa użytkownika</label><br>
                                <input type="text" name="login" id="user-input" class="required" onkeyup="enableSubmit()"><br>
                                ...
                                <input type="password" name="password" id="password-input" class="required" onkeyup="enableSubmit()"><br>
                                <div class="forgetPassword-box">
                                    <a href="#forgetPassword" class="forgetPassword-text">Zapomniałem hasła</a>
                                </div>
                                <div class="loginBtn">
                                    <input type="submit" name="submit" value="Zaloguj się" class="login-register-btn" disabled>
                                </div>
                                <?php 
                                    $error = $_GET['error'];
                                    if($error == "wronglogin") {
                                        echo "<h4 class='error'>Zły login lub hasło</h4>";
                                    }
                                ?>
                            </form>
                        </div>
