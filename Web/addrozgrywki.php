...
<html>
    <head>
        ...
        <title>GearUp Rentals - Dodaj rozgrywke</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="../Styles/main.css">
        <link rel="stylesheet" href="../Styles/addProduct.css">
        <link rel="stylesheet" href="../Styles/rozgrywki.css">
    </head>
    <body>
        <?php 
            ...
            <div class="app-root">
                ...
                <div class="content">
                    <div class="main-title">
                        <h1>Dodaj rozgrywkę</h1>
                    </div>
                        <div class="container imageBox">
                            <h2 class="info">Podaj nazwę rozgrywki oraz wybierz dziedzinę która najepiej pasuje do twojej rozgrywki.</h2>
                            <form action="addrozgrywkiinc.php" method="post" enctype="multipart/form-data">
                                <div class="form">
                                    <div>
                                        <div class="nazwaBox">
                                            <label for="Input">Nazwa rozgrywki*</label><br>
                                ...
                                <div class="imageUploader">
                                    <label for="uploadImg" class="bold">Dodaj zdjęcia do twojej rozgrywki. Maksymalnie 4 zdjęć: </label><br>
                        ...
                        <div class="container container_informacje">
                        <div style="margin-top: 20px;">
                                <label for="date" class="Label">Podaj datę i godzinę rozgrywki*</label><br>
                                <input name="date" id="Input" type="datetime-local">
                            </div>
                            <div style="margin-top: 20px;">
                                <label for="osoby" class="Label">Ile osób potrzebujesz do tej rozgrywki?*</label><br>
                                <input name="osoby" id="Input" type="number">
                            </div>
                        </div>
                        <div class="container">
                        ...
                        <div class="container container_buttons">
                            <input type="submit" class="nav-button-1 nav-text bold buttons" value="Dodaj rozgrywkę">                          
                        </div>
                    </form>
                </div>
